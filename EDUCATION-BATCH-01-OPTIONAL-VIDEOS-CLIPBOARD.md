...
Purpose: One-screen copy for optional Batch 01 Videos 02 and 03.
...
```text
It is not too late to practice reading or math
```
...
```text
Simple 30-minute reading and math routine
```
...
Use the first ready video platform:
...
Optional videos are done when both are marked exported, posted, blocked, or paused.