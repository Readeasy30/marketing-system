...
chrome-devtools-agent/CHROME-DEVTOOLS-QA-WORKFLOW.md
chrome-devtools-agent/CODEX-DEVTOOLS-QA-PROMPT.md
```

Repo-local QA checklists were added to:

```text
Wholelychit/readeasy30.com/DEVTOOLS-QA.md
Wholelychit/matheasy30.com/DEVTOOLS-QA.md
```

Use DevTools QA before heavier promotion because both education sites have app buttons and mobile learner flows.
...
| MathEasy30 DevTools QA checklist | Done | `Wholelychit/matheasy30.com/DEVTOOLS-QA.md` |
| Shared Chrome DevTools QA workflow | Done | `chrome-devtools-agent/` |
| External social posting | Blocked | Requires owner social login/manual posting |
...
| Type | Asset | Status |
|---|---|---|
| Social card | Canva Card 1 — 30 Minutes. One Calm Step. | Designed |
| Social card | Canva Card 2 — Lower the pressure. | Designed |
| Social card | Card 3 — Free Printable Practice | Blocked twice; use worksheet pins |
| Worksheet pin | Reading worksheet pin | Designed |
| Worksheet pin | Math worksheet pin | Designed |
| Adult learner pin | Reading + Math Practice Without Shame for Everyone | Designed |
| Short video | Video 01 — Homework fight? Try this. | Designed |
| Short video | Video 02 — It is not too late. | Designed |
| Short video | Video 03 — Simple 30-minute learning routine. | Designed |
